"""Localhost OAuth-callback server for the GitHub App Manifest flow.

Serves a self-submitting form, lets the operator click "Create GitHub App"
once, catches the redirect on a localhost callback, hands the code back for
conversion.
