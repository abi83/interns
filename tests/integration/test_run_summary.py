...
def test_coder_summary_reports_a_new_pr_and_cost(scenario):
    ...
    body = run_summary(scenario, "--phase", "Coder", "--exec-file", ef, "--issue", ISSUE, "--pr", PR)
...
def test_coder_summary_with_no_pr_flags_the_missing_outcome(scenario):
    ...
    body = run_summary(scenario, "--phase", "Coder", "--exec-file", ef, "--issue", ISSUE)
...
def test_coder_fix_round_reports_an_updated_pr_when_the_head_moved(scenario):
    ...
    body = run_summary(scenario, "--phase", "Coder", "--exec-file", ef, "--issue", ISSUE, "--pr", PR, "--round", "fix")
...
def test_coder_initial_round_reports_the_round_line(scenario):
    ...
    body = run_summary(scenario, "--phase", "Coder", "--exec-file", ef, "--issue", ISSUE, "--pr", PR, "--round", "initial")
...
def test_coder_summary_warns_when_cost_exceeds_the_warn_limit(scenario):
    ...
    body = run_summary(scenario, "--phase", "Coder", "--exec-file", ef, "--issue", ISSUE, "--pr", PR, "--cost-warn", "1.00")
...
def test_coder_summary_notes_a_missing_execution_file(scenario):
    ...
    body = run_summary(scenario, "--phase", "Coder", "--exec-file", "", "--issue", ISSUE)
...
def test_review_summary_reports_an_approval(scenario):
    ...
    body = run_summary(scenario, "--phase", "Review", "--exec-file", ef, "--pr", PR)
...
def test_refinement_summary_reports_the_refined_outcome(scenario):
    ...
    body = run_summary(scenario, "--phase", "Refinement", "--exec-file", ef, "--issue", ISSUE)
...
def test_estimation_summary_reports_the_size(scenario):
    ...
    body = run_summary(scenario, "--phase", "Estimation", "--exec-file", ef, "--issue", ISSUE)
