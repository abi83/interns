...
def test_head_ref_prints_the_branch_name(scenario):
    ...
    result = scenario.run("interns.entrypoint", "gh-query", "--query", "head-ref", "--number", PR)
...
def test_head_sha_prints_the_commit(scenario):
    ...
    result = scenario.run("interns.entrypoint", "gh-query", "--query", "head-sha", "--number", PR)
...
def test_closing_issue_prints_the_first_linked_number(scenario):
    ...
    result = scenario.run("interns.entrypoint", "gh-query", "--query", "closing-issue", "--number", PR)
...
def test_pr_for_issue_finds_the_open_pr_that_closes_it(scenario):
    ...
    result = scenario.run("interns.entrypoint", "gh-query", "--query", "pr-for-issue", "--number", ISSUE)
...
def test_prompt_concatenates_files_into_one_output(scenario):
    ...
    result = scenario.run("interns.prompt", str(first), str(second))
